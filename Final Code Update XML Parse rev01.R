# Revision 01 date:        25-10-2016
#             description: Add opposition team name.
#             by:          LFE
...
for (f in f24.files) { 
  ...
  saveRDS(events, outfile)        ## amended
  print(paste("File", outfile, "saved to RDS"))
}


# To retrieve a file, execute a line like the following
...
dat2 = rbindlist(dat_list, fill = TRUE)
